...
DISTRICT_SHAPEFILE = "static-data/ffac_Kommunen_wgs84/ffac_Kommunen.shp"
...
STATISTICS_OUTPUT_PATH = "data/ffac-kommunen-statistics.json"

# The output path for the plotted map
# Set to None for interactive output
MAP_OUTPUT_PATH = "data/ffac-kommunen-nodes.png"
